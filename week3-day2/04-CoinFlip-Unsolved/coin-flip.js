$(document).ready(function() {
  ...
  function flipThatCoin(result) {
    ...
    //  STEP ONE:
      ...
      // randomNumber = Math.floor(Math.random() + 0.5);
    ...
    //  STEP TWO:
      ...
      if(randomNumber === 0) {
        ...
        var imgTag = $("<img>");
        imgTag.attr("src", "http://random-ize.com/coin-flip/us-quarter/us-quarter-front.jpg");
        imgTag.attr("class", "myImg");
        $("#coin-image").empty().append(imgTag);
        // $("#coin-image").append(imgTag);
      ...
      // Else:
        ...
        var imgTag = $("<img>");
        imgTag.attr("src", "http://random-ize.com/coin-flip/us-quarter/us-quarter-back.jpg");
        imgTag.attr("class", "myImg");
        $("#coin-image").empty().append(imgTag);
        // $("#coin-image").append(imgTag);
